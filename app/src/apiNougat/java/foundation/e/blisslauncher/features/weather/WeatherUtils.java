...
public final class WeatherUtils {
  ...
  public static String resolveWeatherCondition(Context context, int conditionCode) {
    ...
    final int resId =
        res.getIdentifier(
            "weather_" + WeatherUtils.addOffsetToConditionCodeFromWeatherContract(conditionCode),
            "string",
   ...
   * @return The formatted string if a valid value is provided, "-" otherwise. Decimals are removed
   */
   ...
   * @param windSpeedUnit The speed unit. See {@link
   *     lineageos.providers.WeatherContract.WeatherColumns.WindSpeedUnit}
   * @return The formatted string if a valid speed and speed unit a provided. {@link
   *     R.string#unknown} otherwise
   */
  ...
  public static int addOffsetToConditionCodeFromWeatherContract(int conditionCode) {
    if (conditionCode <= WeatherContract.WeatherColumns.WeatherCode.SHOWERS) {
      return conditionCode;
        ...
        <= WeatherContract.WeatherColumns.WeatherCode.SCATTERED_THUNDERSTORMS) {
      ...
      return conditionCode + 2;
        ...
        <= WeatherContract.WeatherColumns.WeatherCode.ISOLATED_THUNDERSHOWERS) {
