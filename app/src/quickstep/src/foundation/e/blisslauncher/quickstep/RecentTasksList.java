...
public class RecentTasksList extends TaskStackChangeListener {
  ...
  public synchronized int getTasks(boolean loadKeysOnly, Consumer<ArrayList<Task>> callback) {
    ...
    Runnable resultCallback = callback == null ? () -> {} : () -> callback.accept(copyOf(mTasks));
  ...
  @Override
  public synchronized void onActivityPinned(
      String packageName, int userId, int taskId, int stackId) {
    mChangeId++;
  }
  ...
  private ArrayList<Task> loadTasksInBackground(int numTasks, boolean loadKeysOnly) {
    ...
    SparseBooleanArray tmpLockedUsers =
