...
public class AnimatedFloat {
  ...
  public static FloatProperty<AnimatedFloat> VALUE =
  ...
  /**
   * Changes the value and calls the callback. Note that the value can be directly accessed as well
   * to avoid notifying the callback.
   */
