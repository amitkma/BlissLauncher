...
public class Themes {
  ...
  public static String getDefaultBodyFont(Context context) {
    TypedArray ta =
        context.obtainStyledAttributes(
            android.R.style.TextAppearance_DeviceDefault, new int[] {android.R.attr.fontFamily});
   ...
   *
   * <p>The matrix will, for instance, turn white into r g b a, and black will remain black.
   *
   ...
   *
   * <p>Note that values on the last column of target ColorMatrix can be negative, and may result in
   * negative values when applied on a color. Such negative values will be automatically shifted up
   * to 0 by the framework.
   *
