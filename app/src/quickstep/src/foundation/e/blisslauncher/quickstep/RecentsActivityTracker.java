...
public class RecentsActivityTracker<T extends BaseRecentsActivity>
  ...
  private static class Scheduler implements Runnable {
    ...
    public synchronized boolean initIfPending(BaseRecentsActivity activity, boolean alreadyOnHome) {
