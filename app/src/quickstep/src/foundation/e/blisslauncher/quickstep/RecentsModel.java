...
public class RecentsModel extends TaskStackChangeListener {
  ...
  private RecentsModel(Context context) {
    mContext = context;
    HandlerThread loaderThread =
        new HandlerThread("TaskThumbnailIconCache", Process.THREAD_PRIORITY_BACKGROUND);
    loaderThread.start();
   ...
   *
   * @param callback The callback to receive the task plan once its complete or null. This is always
  ...
  public void onTaskStackChangedBackground() {
    ...
    mTaskList.getTaskKeys(
        mThumbnailCache.getCacheSize(),
        tasks -> {
          for (Task task : tasks) {
