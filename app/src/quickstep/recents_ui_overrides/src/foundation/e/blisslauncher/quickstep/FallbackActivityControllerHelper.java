 ...
 * currently running one and apps should interact with the {@link RecentsActivity} as opposed to the
 * in-launcher one.
 */
public final class FallbackActivityControllerHelper
    implements ActivityControlHelper<RecentsActivity> {
    ...
    return new AnimationFactory() {
      ...
      public void onRemoteAnimationReceived(RemoteAnimationTargetSet targets) {
        ...
        createActivityController(
            getSwipeUpDestinationAndLength(activity.getDeviceProfile(), activity, new Rect()));
      }
      ...
      public void createActivityController(long transitionLength) {
        ...
        controller.setEndAction(
            () -> {
              ...
              rv.setInOverviewState(
                  controller.getInterpolatedProgress() > 0.5 ? endState : fromState);
            });
