...
public class SwipeSharedState implements SwipeAnimationTargetSet.SwipeAnimationListener {
  ...
  public RecentsAnimationListenerSet newRecentsAnimationListenerSet() {
    ...
    boolean shouldMinimiseSplitScreen =
        mOverviewComponentObserver == null
            ? false
            : mOverviewComponentObserver.getActivityControlHelper().shouldMinimizeSplitScreen();
    mRecentsAnimationListener =
        new RecentsAnimationListenerSet(shouldMinimiseSplitScreen, this::onSwipeAnimationFinished);
  ...
  public void applyActiveRecentsAnimationState(
      SwipeAnimationTargetSet.SwipeAnimationListener listener) {
    if (mLastAnimationTarget != null) {
