...
import static foundation.e.blisslauncher.core.Utilities.FLAG_NO_GESTURES;
...
public class RecentsAnimationWrapper {
  ...
  public RecentsAnimationWrapper(
      InputConsumerController inputConsumerController, Supplier<InputConsumer> inputProxySupplier) {
  ...
  /**
   * @param onFinishComplete A callback that runs on the main thread after the animation controller
   *     has finished on the background thread.
   * @param sendUserLeaveHint Determines whether userLeaveHint flag will be set on the pausing
   *     activity. If userLeaveHint is true, the activity will enter into picture-in-picture mode
   *     upon being paused.
   */
  @UiThread
  ...
  private void finishAndClear(
      boolean toRecents, Runnable onFinishComplete, boolean sendUserLeaveHint) {
