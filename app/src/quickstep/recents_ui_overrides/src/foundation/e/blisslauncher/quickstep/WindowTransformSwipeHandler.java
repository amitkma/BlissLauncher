...
public class WindowTransformSwipeHandler<T extends BaseDraggingActivity>
    ...
    public WindowTransformSwipeHandler(RunningTaskInfo runningTaskInfo, Context context,
        ...
        VariantDeviceProfile dp = BlissLauncher.getApplication(context).getInvariantDeviceProfile().getDeviceProfile(context);
    ...
    private float getTaskCurveScaleForOffsetX(float offsetX, float taskWidth) {
        float distanceToReachEdge = mDp.getWidthPx() / 2 + taskWidth / 2 +
    ...
    public void onRecentsAnimationStart(SwipeAnimationTargetSet targetSet) {
        VariantDeviceProfile dp = BlissLauncher.getApplication(mContext).getInvariantDeviceProfile().getDeviceProfile(mContext);
    ...
    private RectFSpringAnim createWindowAnimationToHome(float startProgress,
        ...
        anim.addOnUpdateListener((currentRect, progress) -> {
            ...
            float windowAlpha = Utilities.boundToRange(Utilities.mapToRange(alphaProgress, 0,
                    windowAlphaThreshold, 1.5f, 0f, LINEAR), 0, 1);
