...
public class LauncherRecentsView extends RecentsView<TestActivity>
    implements LauncherStateManager.StateListener {
  ...
  public void redrawLiveTile(boolean mightNeedToRefill) {
    ...
    if (taskView != null) {
      ...
      int offsetX = (int) (mTaskWidth * taskView.getScaleX() * getScaleX() - mTempRect.width());
      int offsetY = (int) (mTaskHeight * taskView.getScaleY() * getScaleY() - mTempRect.height());
  ...
  public void setOverviewStateEnabled(boolean enabled) {
    ...
    if (enabled) {
      ...
      boolean hasClearAllButton =
          (state.getVisibleElements(mActivity) & RECENTS_CLEAR_ALL_BUTTON) != 0;
  ...
  protected boolean shouldStealTouchFromSiblingsBelow(MotionEvent ev) {
    if (ev.getAction() == MotionEvent.ACTION_DOWN) {
      ...
      boolean touchingHotseat =
          hotseat.isShown() && mActivity.getDragLayer().isEventOverView(hotseat, ev, this);
