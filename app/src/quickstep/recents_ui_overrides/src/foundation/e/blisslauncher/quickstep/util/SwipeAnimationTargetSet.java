...
import static foundation.e.blisslauncher.quickstep.TouchInteractionService.BACKGROUND_EXECUTOR;
...
/**
 * Extension of {@link RemoteAnimationTargetSet} with additional information about swipe up
 * animation
 */
public class SwipeAnimationTargetSet extends RemoteAnimationTargetSet {
  ...
  public SwipeAnimationTargetSet(
  ...
  /**
   * Clones the target set without any actual targets. Used only when continuing a gesture after the
   * actual recents animation has finished.
   */
  public SwipeAnimationTargetSet cloneWithoutTargets() {
    return new SwipeAnimationTargetSet(
        controller,
