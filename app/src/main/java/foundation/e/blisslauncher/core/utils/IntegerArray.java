...
/**
 * Copy of the platform hidden implementation of android.util.IntArray. Implements a growing array
 * of int primitives.
 */
public class IntegerArray implements Cloneable {
  ...
  /**
   * Inserts a value at the specified position in this array. If the specified index is equal to the
   * length of the array, the value is added at the end.
   *
  ...
  /**
   * Returns the index of the first occurrence of the specified value in this array, or -1 if this
