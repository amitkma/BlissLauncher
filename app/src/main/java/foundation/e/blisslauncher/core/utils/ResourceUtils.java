...
public class ResourceUtils {
  ...
  /**
   * Sets a fake configuration to the passed Resources to allow access to resources accessible to a
   * sdk level. Used to backport adaptive icon support to different devices.
   *
