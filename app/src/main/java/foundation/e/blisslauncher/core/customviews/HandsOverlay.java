...
public class HandsOverlay implements DialOverlay {
  ...
  public void onDraw(
    ...
    canvas.save();
    if (!CustomAnalogClock.hourOnTop) drawHours(canvas, cX, cY, w, h, calendar, sizeChanged);
    else drawMinutes(canvas, cX, cY, w, h, calendar, sizeChanged);
    canvas.restore();

    canvas.save();
    if (!CustomAnalogClock.hourOnTop) drawMinutes(canvas, cX, cY, w, h, calendar, sizeChanged);
    else drawHours(canvas, cX, cY, w, h, calendar, sizeChanged);
    canvas.restore();

    canvas.save();
    if (!CustomAnalogClock.hourOnTop) drawSec(canvas, cX, cY, w, h, calendar, sizeChanged);
    else drawSec(canvas, cX, cY, w, h, calendar, sizeChanged);
    canvas.restore();
  }
