...
public class SecureSettingsObserver extends ContentObserver {
  ...
  public SecureSettingsObserver(
      ContentResolver resolver, OnChangeListener listener, String keySetting, int defaultValue) {
    super(new Handler());
  ...
  public static SecureSettingsObserver newNotificationSettingsObserver(
      Context context, OnChangeListener listener) {
