...
public class Utilities {
  ...
  /**
   * Set on a motion event do disallow any gestures and only handle touch. See {@link
  ...
  /**
   * Trims the string, removing all whitespace at the beginning and end of the string. Non-breaking
  ...
  public static float getDescendantCoordRelativeToAncestor(
    ...
    return getDescendantCoordRelativeToAncestor(
        descendant, ancestor, coord, includeRootScroll, false, null);
  }
  ...
  /**
   * Utility method to determine whether the given point, in local coordinates, is inside the view,
   * where the area of the view is expanded by the slop factor. This method is called while
  ...
  public static SharedPreferences getPrefs(Context context) {
    return context.getSharedPreferences("foundation.e.blisslauncher.prefs", Context.MODE_PRIVATE);
  }
  ...
  public static float mapToRange(
      float t, float fromMin, float fromMax, float toMin, float toMax, Interpolator interpolator) {
