...
public class LauncherState {
  ...
  /**
   * True if the workspace pages should not be clipped relative to the workspace bounds for this
   * state.
   */
  ...
  public LauncherState(int id, int transitionDuration, int flags) {
    ...
    this.workspaceAccessibilityFlag =
        (flags & FLAG_DISABLE_ACCESSIBILITY) != 0
  ...
  /**
   * Returns 2 floats designating how to transition overview: scale for the current and adjacent
   * pages translationY factor where 0 is top aligned and 0.5 is centered vertically
   */
   ...
   * include: - Setting interpolators for various animations included in the state transition. -
