...
import foundation.e.blisslauncher.uioverrides.WallpaperColorInfo;

/** View scrim which draws behind hotseat and workspace */
public class WorkspaceAndHotseatScrim
    implements View.OnAttachStateChangeListener, WallpaperColorInfo.OnChangeListener {
  ...
  private LauncherPagedView mWorkspace;
  ...
  public WorkspaceAndHotseatScrim(View view) {
    mRoot = view;
    mLauncher = TestActivity.Companion.getLauncher(view.getContext());
    mWallpaperColorInfo = WallpaperColorInfo.getInstance(mLauncher);

    mMaskHeight =
        ResourceUtils.pxFromDp(ALPHA_MASK_BITMAP_DP, view.getResources().getDisplayMetrics());
  ...
  public void setWorkspace(LauncherPagedView workspace) {
  ...
  public void onExtractedColorsChanged(WallpaperColorInfo wallpaperColorInfo) {
    ...
    mBottomMaskPaint.setColor(
        ColorUtils.compositeColors(DARK_SCRIM_COLOR, wallpaperColorInfo.getMainColor()));
    reapplySysUiAlpha();
  ...
  public Bitmap createDitheredAlphaMask() {
    ...
    LinearGradient lg =
        new LinearGradient(
            ...
            gradientHeight,
            new int[] {
              0x00FFFFFF, setColorAlphaBound(Color.WHITE, (int) (0xFF * 0.95)), 0xFFFFFFFF
            },
