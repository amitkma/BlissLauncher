...
public class LauncherAppState {
  ...
  private final ArrayMap<OnAppsChangedCallback, WrappedCallback> mCallbacks = new ArrayMap<>();
  ...
  protected void onNotificationSettingsChanged(boolean areNotificationDotsEnabled) {
    if (areNotificationDotsEnabled) {
      NotificationListener.requestRebind(new ComponentName(mContext, NotificationListener.class));
    }
  }
