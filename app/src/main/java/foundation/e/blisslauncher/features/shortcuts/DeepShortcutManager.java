...
public class DeepShortcutManager {
   ...
   *
   * <p>This method is intended to get the full details for shortcuts when they are added or
   * updated, because we only get "key" fields in onShortcutsChanged().
   */
  public List<ShortcutInfo> queryForFullDetails(
      String packageName, List<String> shortcutIds, UserHandle user) {
   ...
   */
  public List<ShortcutInfo> queryForShortcutsContainer(
      ComponentName activity, List<String> ids, UserHandle user) {
    return query(
  ...
  public Drawable getShortcutIconDrawable(ShortcutInfoCompat shortcutInfo, int density) {
    return getShortcutIconDrawable(shortcutInfo.getShortcutInfo(), density);
  }
   ...
   *
   * <p>If packageName is null, returns all pinned shortcuts regardless of package.
   */
   ...
   *
   * <p>TODO: Use the cache to optimize this so we don't make an RPC every time.
   */
  @TargetApi(25)
  private List<ShortcutInfo> query(
      int flags,
      String packageName,
