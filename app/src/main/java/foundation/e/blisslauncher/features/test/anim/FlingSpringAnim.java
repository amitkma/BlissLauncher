...
/**
 * Given a property to animate and a target value and starting velocity, first apply friction to the
 * fling until we pass the target, then apply a spring force to pull towards the target.
 */
