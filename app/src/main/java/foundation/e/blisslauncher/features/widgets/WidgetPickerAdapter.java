...
public class WidgetPickerAdapter
    extends RecyclerView.Adapter<WidgetPickerAdapter.WidgetsViewHolder> {
  ...
  public static class Item {
    ...
    /**
     * Build the {@link Intent} described by this item. If this item can't create a valid {@link
     * android.content.ComponentName}, it will return {@link Intent#ACTION_CREATE_SHORTCUT} filled
     * with the item label.
     */
