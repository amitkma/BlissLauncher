 ...
 * durations.
 *
 * <p>Note: The implementation does not support start delays on child animations or sequential
 * playbacks.
 */
public abstract class AnimatorPlaybackController implements ValueAnimator.AnimatorUpdateListener {
  ...
  /**
   * Creates an animation controller for the provided animation. The actual duration does not matter
   * as the animation is manually controlled. It just needs to be larger than the total number of
   * pixels so that we don't have jittering due to float (animation-fraction * total duration) to
   * int conversion.
   */
  public static AnimatorPlaybackController wrap(
      AnimatorSet anim, long duration, Runnable onCancelRunnable) {
  ...
  private void dispatchOnStartRecursively(Animator animator) {
    List<AnimatorListener> listeners =
        animator instanceof SpringObjectAnimator
  ...
  public static class AnimatorPlaybackControllerVL extends AnimatorPlaybackController {
    ...
    private AnimatorPlaybackControllerVL(
        AnimatorSet anim, long duration, Runnable onCancelRunnable) {
