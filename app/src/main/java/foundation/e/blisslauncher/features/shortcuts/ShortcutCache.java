...
/**
 * Loads {@link ShortcutInfoCompat}s on demand (e.g. when launcher loads for pinned shortcuts and on
 * long-press for dynamic shortcuts), and caches them for handful of apps in an LruCache while
 * launcher lives.
 */
...
public class ShortcutCache {
   ...
   *
   * <p>Returns a map of ids to their evicted shortcuts.
   *
