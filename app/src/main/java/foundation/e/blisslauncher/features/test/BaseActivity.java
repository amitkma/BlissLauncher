...
public abstract class BaseActivity extends Activity {
  ...
  @IntDef(
      flag = true,
      value = {
        INVISIBLE_BY_STATE_HANDLER,
        INVISIBLE_BY_APP_TRANSITIONS,
        INVISIBLE_BY_PENDING_FLAGS,
  ...
  @ActivityFlags private int mActivityFlags;
  ...
  public void addOnDeviceProfileChangeListener(
      VariantDeviceProfile.OnDeviceProfileChangeListener listener) {
    mDPChangeListeners.add(listener);
  }

  public void removeOnDeviceProfileChangeListener(
      VariantDeviceProfile.OnDeviceProfileChangeListener listener) {
